...
class MakeDataset:
    def __init__(self):
        self.intent_data_dir = "./dataset/intent_data.csv"
        self.intent_label_dir = "./dataset/intent_label.json"
        self.entity_label_dir = "./dataset/entity_label.json"
        self.entity_data_dir = "./dataset/entity_data.csv"
        self.ood_dataset_dir = "./dataset/ood_data.csv"
    ...
    def make_ood_dataset(self, embed):
        intent_dataset = pd.read_csv(self.intent_data_dir)
        ood_dataset = pd.read_csv(self.ood_dataset_dir)
