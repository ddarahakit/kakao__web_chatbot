...
class NaturalLanguageUnderstanding:
    ...
    def model_load(self):
        intent_pretrain_path = "./nlp/pretrained/intent_clsf_99.438_steps_5.pt"
        entity_pretrain_path = "./nlp/pretrained/entity_recog_95.452_steps_4.pt"
        ood_pretrain_path = "./nlp/pretrained/ood_clsf_99.663_steps_9.pt"
